var suggestions = [{ videoTitle:'الصور الاولى للزلزال الذي ضرب جنوب إيران', thumbnailSrc:'https://i4.ytimg.com/vi/SaU_a1x1AcA/default.jpg'}, 
...
for (index = 0; index < suggestions.length; ++index) {
	...
	console.log(suggest.videoTitle);
}
